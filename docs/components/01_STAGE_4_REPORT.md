...
- Контрольный повтор обоих importers: 0 updated; полный content hash до/после совпал (`5b5c9e…6b0`).
...
- Git baselines: import/deploy guard `994516a`; isolated component library `86eebe5`; canonical-media idempotency fix `791f245`.
