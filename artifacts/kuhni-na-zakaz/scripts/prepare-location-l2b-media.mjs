...
const evidenceRoot = path.resolve(projectRoot, "..", "..", "artifacts", "location-visual-corrective", "l2b", "contact-sheets");
const cities = ["vileyka", "nesvizh", "volozhin", "myadel"];

await fs.mkdir(evidenceRoot, { recursive: true });

for (const city of cities) {
  const directory = path.join(publicRoot, `${city}-visual-l2b`);
...
console.log("Prepared 16 L2B masters with WebP/AVIF parity, mobile WebP derivatives and four contact sheets.");
