...
export default defineConfig({
  testDir: "./tests/smoke",
  testMatch: "location-visual-l2a.spec.ts",
  outputDir: `../../artifacts/location-visual-corrective/l2a/${reportLabel}-results`,
  timeout: 120_000,
  fullyParallel: false,
  workers: 1,
  reporter: [
    ["list"],
    ["json", { outputFile: `../../artifacts/location-visual-corrective/l2a/${reportLabel}.json` }],
  ],
