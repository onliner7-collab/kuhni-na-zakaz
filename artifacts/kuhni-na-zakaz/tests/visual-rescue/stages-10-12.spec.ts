...
const evidenceRoot = "../../artifacts/visual-rescue/stages-10-12";
...
const targets = [
  {
    ...
    slug: "stage-10",
    explorer: '[data-interaction-role="opening-mechanism-comparison"]',
    firstAction: "Профиль",
    resultAction: "Верхний фасад",
  },
  {
    route: "/styles/neoklassika",
    slug: "stage-11",
    explorer: '[data-series-id="STYLE-NEOCLASSIC-2026-07-23"]',
    firstAction: "Тонкая рамка",
    resultAction: "Сравнить с классикой",
  },
  {
    route: "/styles/hay-tek",
    slug: "stage-12",
    explorer: '[data-series-id="STYLE-HIGHTECH-2026-07-23"]',
    firstAction: "Техника",
    resultAction: "Сравнить с минимализмом",
  },
];
