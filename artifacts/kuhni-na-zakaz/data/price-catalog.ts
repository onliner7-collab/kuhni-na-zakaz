...
export const kitchenStyles: KitchenStyleOption[] = [
  {
    ...
    alt: "Современная минималистичная кухня на заказ в Минске",
  },
  {
    id: "light-modern",
    ...
    alt: "Светлая современная кухня на заказ с лаконичными фасадами",
  },
  {
    id: "dark-modern",
    title: "Тёмная кухня",
    ...
    alt: "Тёмная кухня на заказ с матовыми фасадами и подсветкой",
  },
  {
    id: "warm-wood",
    ...
    alt: "Кухня с древесной текстурой фасадов на заказ",
  },
  {
    id: "neoclassic",
    title: "Неоклассика",
    ...
    priceFrom: 3000,
    variantsCount: 8,
    image: "/images/design-proekt-kuhni/config-style-neoclassic.webp",
    alt: "Неоклассическая кухня на заказ с рамочными фасадами",
  },
  {
    id: "scandi",
...
export const priceKitchenModels: PriceKitchenModel[] = [
  {
    ...
    budget: "2000-4000",
    coverImage: "/images/design-proekt-kuhni/3d-proekt-kuhnya-bez-ruchek.webp",
    coverAlt: "Минималистичная угловая кухня без ручек в Минске",
    ...
    gallery: gallery(
      ...
      [
        "/images/design-proekt-kuhni/3d-proekt-kuhnya-bez-ruchek.webp",
  ...
  },
  {
    ...
    is3dVisualization: true,
    budget: "2000-4000",
    coverImage: "/images/design-proekt-kuhni/3d-proekt-pryamaya-kuhnya.webp",
    coverAlt: "Светлая прямая кухня на заказ для квартиры",
  ...
  },
  {
    ...
    coverAlt: "Тёмная угловая кухня с островом и подсветкой",
  ...
  },
  {
    ...
    is3dVisualization: true,
    budget: "2000-4000",
    coverImage: "/images/design-proekt-kuhni/config-style-warm-wood.webp",
    coverAlt: "Угловая кухня с древесной фактурой фасадов",
  ...
  },
  {
    ...
    is3dVisualization: true,
    budget: "2000-4000",
    coverImage: "/images/design-proekt-kuhni/3d-proekt-neoklassicheskaya-kuhnya.webp",
    coverAlt: "Неоклассическая угловая кухня на заказ",
    ...
    gallery: gallery(
      ...
      [
        "/images/design-proekt-kuhni/3d-proekt-neoklassicheskaya-kuhnya.webp",
