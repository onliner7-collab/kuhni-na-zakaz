    ...
    <div className="min-h-screen flex flex-col bg-background">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="tel:+375293720674" className="font-medium hover:text-primary transition-colors">
              +375 (29) 372-06-74
            </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t bg-background p-4 absolute w-full left-0 top-16">
            <nav className="flex flex-col gap-4">
              ...
              <a href="tel:+375293720674" className="text-lg font-medium mt-4">
                +375 (29) 372-06-74
              </a>
            </nav>
          </div>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="tel:+375293720674" className="hover:text-primary">+375 (29) 372-06-74</a></li>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full bg-background border-t p-4 flex gap-4 z-50 pb-safe">
        <Button variant="outline" className="flex-1" asChild>
          <a href="tel:+375293720674"><Phone className="w-4 h-4 mr-2" /> Позвонить</a>
        </Button>
