  ...
  return (
    <div className="relative overflow-hidden rounded-[1.5rem] bg-stone-200" data-location-visual-stage>
      <picture key={state.id}>
        <source srcSet={state.avifImage} type="image/avif" />
        <img
          src={state.image}
          alt={state.altRu}
          width={1200}
          ...
          onError={onError}
          onLoad={onLoad}
          className="aspect-[3/2] h-auto w-full object-cover motion-safe:animate-[fade-in_.2s_ease-out] motion-reduce:animate-none"
        />
      </picture>
