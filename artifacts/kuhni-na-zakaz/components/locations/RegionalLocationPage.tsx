...
const minskOrderGuides = [
  {
    title: "Лучший вариант для маленькой кухни",
    text: "Для небольшой минской квартиры сравним прямую и угловую планировки. На замере проверим проходы, место под технику и доступ к хранению — особенно рядом с коробами и подоконником.",
    href: "/catalog/malenkie-kuhni",
  },
  {
    title: "Бюджет и установка под ключ",
    text: "Чтобы купить кухню в Минске в пределах бюджета, согласуем комплектацию и состав работ. Доставку и монтаж привяжем к готовности помещения; сроки фиксируются после согласования проекта.",
    href: "/prices",
  },
  {
    title: "Расчёт кухни для вашего помещения",
    text: "Пришлите план, фото и список техники для предварительного расчёта. Для точной сметы уточним размеры, фасады, столешницу, фурнитуру и условия доставки по вашему адресу в Минске.",
    href: "/prices",
  },
  {
    title: "Что проверить до подписания договора",
    text: "Проверьте чертёж, материалы, модели механизмов, итоговую стоимость и сроки. Уточните состав монтажных работ и гарантийные условия. При выборе по изображениям обращайте внимание на подписи: концепция или подтверждённый объект.",
    href: "/portfolio",
  },
];
        ...
        <section className="bg-muted/30 section-padding">
          <div className="container-site">
            <SectionTitle
              ...
              text="Сравните планировки, уточните стоимость комплектации и согласуйте условия работ по вашему адресу. Эти шаги помогут подготовиться к заказу кухни."
            />
            <div className="grid gap-4 md:grid-cols-2">
              {minskOrderGuides.map((item) => (
