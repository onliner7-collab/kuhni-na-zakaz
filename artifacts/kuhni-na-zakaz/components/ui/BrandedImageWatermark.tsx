...
export function BrandedImageWatermark({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "absolute bottom-3 right-3 select-none rounded-md border border-white/25 bg-black/28 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-white/70 shadow-sm backdrop-blur-[1px]",
