                ...
                <div className="mx-auto grid max-w-7xl gap-2 sm:grid-cols-2">
                  {primaryLinks.map(([href, label]) => (
                    <Link
                      key={href}
                      href={href}
                      className="flex min-h-11 items-center rounded-xl bg-muted/60 px-4 py-3 text-sm font-bold"
                    >
                      {label}
                    </Link>
                  ))}
                  {secondaryLinks.map(([href, label]) => (
                    <Link
                      key={href}
                      href={href}
                      className="flex min-h-11 items-center rounded-xl px-4 py-3 text-sm font-semibold"
                    >
                      {label}
                    </Link>
                  ))}
