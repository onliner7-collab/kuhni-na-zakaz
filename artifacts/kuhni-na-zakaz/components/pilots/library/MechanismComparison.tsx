...
interface MechanismComparisonProps { title: string; options: LabeledOption[]; }

export function MechanismComparison({ title, options }: MechanismComparisonProps) {
