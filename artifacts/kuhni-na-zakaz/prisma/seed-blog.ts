...
**Итого**: прямая кухня из МДФ — от 1 200 BYN. Угловая из эмали — от 2 500 BYN. С островом из шпона — от 5 000 BYN.`,
  },
  {
    ...
    seoDescription: "10 дизайнерских приёмов для маленькой кухни 6–9 м²: шкафы до потолка, встроенная техника, скрытые ручки.",
...
Минимальная площадь кухни — от 14–16 м². Остров требует прохода не менее 90 см со всех сторон. В квартире 9–12 м² он только мешает.
