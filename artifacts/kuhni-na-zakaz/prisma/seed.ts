  ...
  if (reviewsCount === 0) {
    await prisma.review.createMany({
      data: [
        ...
        { name: "Игорь Степанов", city: "Молодечно", rating: 4, text: "Кухня в частный дом, П-образная, 18 кв. м. Сделали качественно. Монтаж немного затянулся, но предупредили заранее.", date: "Октябрь 2024", status: "PUBLISHED" },
        { name: "Марина Соколова", city: "Минск", rating: 5, text: "Маленькая кухня для студии, 6 квадратов. Всё продумано до мелочей. Трансформируемая столешница — вообще находка.", date: "Сентябрь 2024", status: "PUBLISHED" },
      ],
    });
