...
legacyRegistry.push(
  ...
  { fromRoute: "/styles", fromState: "RESULT", userQuestion: "Как проверить выбранный визуальный язык?", actionType: "DEEPEN", anchorRu: "Разобрать современный стиль по деталям", toRoute: "/styles/sovremennye", contextPatch: { sourceRoute: "/styles" }, reasonRu: "Detail page отдельно сравнивает плоскости, фактуры, детали и свет.", priority: 1, requiresEvidence: false, fallbackRoute: "/styles", analyticsEvent: "exploration_transition_click", status: "active" },
  { fromRoute: "/styles", fromState: "RESULT", userQuestion: "С чем связать стиль?", actionType: "COMPARE", anchorRu: "Сравнить материалы для выбранного образа", toRoute: "/materials", contextPatch: { sourceRoute: "/styles" }, reasonRu: "Материалы помогают проверить поверхность и уход после выбора визуального направления.", priority: 2, requiresEvidence: false, fallbackRoute: "/styles", analyticsEvent: "exploration_compare", status: "active" },
  { fromRoute: "/styles", fromState: "RESULT", userQuestion: "Как перейти к проекту?", actionType: "CONVERT", anchorRu: "Передать стиль в дизайн-проект", toRoute: "/design-proekt-kuhni", contextPatch: { sourceRoute: "/styles" }, reasonRu: "Проект связывает стиль с помещением и планировкой без обещания готового результата.", priority: 3, requiresEvidence: false, fallbackRoute: "/calculator", analyticsEvent: "lead_open_with_context", status: "active" },
