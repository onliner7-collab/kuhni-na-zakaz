...
export default defineConfig({
  testDir: "./tests/smoke",
  testMatch: "location-visual-l1b.spec.ts",
  outputDir: `../../artifacts/location-visual-corrective/l1b/${reportLabel}-results`,
  timeout: 120_000,
  fullyParallel: false,
  workers: 1,
  reporter: [
    ["list"],
    ["json", { outputFile: `../../artifacts/location-visual-corrective/l1b/${reportLabel}.json` }],
  ],
