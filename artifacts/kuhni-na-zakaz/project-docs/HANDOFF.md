...
| Brand & positioning cleanup | ✅ Done | Убраны старые fallback-домены из metadataBase/OG/Footer. Статические страницы приведены к бренду "КухниBY", домен → kuhni.minsk.by |
