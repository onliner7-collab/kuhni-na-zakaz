...
const advancedHardwareSections = [
  ...
  },
  {
    ...
    items: [
      ...
      "Встроенный розеточный блок подбирают под сценарии готовки, расположение техники и толщину столешницы.",
      "Стыковочная планка, торцевая планка и пристеночный бортик защищают соединения, открытые торцы и зону примыкания к стене.",
      "Силиконовые демпферы, заглушки для крепежа и уплотнители делают кухню тише, аккуратнее и устойчивее к влаге в проблемных местах.",
    ],
  },
];
