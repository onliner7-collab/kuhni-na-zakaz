...
export const metadata: Metadata = {
  title: "Портфолио кухонь на заказ — реальные проекты по Беларуси | КухниBY",
  description: "Реализованные проекты кухонь на заказ по всей Беларуси. Фото, площадь, бюджет, сроки. Минск, Брест, Гродно, Витебск, Гомель, Могилёв.",
