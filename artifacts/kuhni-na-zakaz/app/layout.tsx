...
const homeTitle = "Купить кухню на заказ по индивидуальным размерам";
const homeDescription =
  "Кухни на заказ: выбор планировки и материалов, замер по заявке, 3D-проект, изготовление и монтаж. Рассчитаем стоимость под ваши размеры и комплектацию.";
