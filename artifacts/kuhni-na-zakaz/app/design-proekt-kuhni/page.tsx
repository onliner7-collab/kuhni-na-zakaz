...
const workflow = [
  ...
  },
  {
    ...
    text: "Специалист уточняет размеры или предлагает замер, затем собирает рабочую схему.",
  },
  {
    step: "03",
...
const faqItems = [
  {
    question: "Кто готовит проект кухни?",
    answer:
      "Проект готовит специалист. Так можно учесть реальные размеры, коммуникации, технику и ограничения помещения.",
  },
  {
        ...
        <section className="section-padding">
          <div className="container-site grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Мы не просим вас самостоятельно собирать модули на экране. Специалист переводит пожелания в понятную планировку и визуальный проект.
              </p>
            </div>
