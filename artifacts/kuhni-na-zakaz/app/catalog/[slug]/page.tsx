...
const STATIC_CATEGORIES: Record<string, { title: string; description: string; priceFrom: number; features: string[]; content: string }> = {
  "uglovye-kuhni": {
    ...
    content: "Угловая кухня — одно из самых популярных решений для жилых квартир. Она позволяет рационально использовать угловую зону и создать эргономичное рабочее пространство. Подходит для кухонь от 2 п.м.",
  },
  "pryamye-kuhni": {
  ...
  "p-obraznye-kuhni": {
    ...
    content: "П-образная кухня обеспечивает максимальное рабочее и хранительное пространство. Идеальна для кухонь от 4 п.м и больших семей.",
  },
  "kuhni-s-ostrovom": {
  ...
  "malenkie-kuhni": {
    ...
    content: "Маленькая кухня — это не ограничение, а задача для дизайнера. Мы создаём кухни на 1.5–2 п.м, в которых продуман каждый сантиметр и все функции.",
  },
  "kuhni-do-potolka": {
