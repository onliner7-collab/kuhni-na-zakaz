...
const STATIC_CATEGORIES: Record<string, StaticCategory> = {
  ...
  "pryamye-kuhni": {
    title: "Прямые кухни на заказ — купить кухню вдоль одной стены",
    description: "Прямые кухни на заказ для узких помещений и студий. Сравните размещение мойки, техники и хранения вдоль одной стены. Расчёт по размерам и комплектации.",
    priceFrom: 1200,
  ...
  "p-obraznye-kuhni": {
    title: "П-образные кухни на заказ — планировки и расчёт цены",
    description: "П-образные кухни на заказ: три рабочие стороны, хранение и размещение техники. Посмотрите варианты и ограничения по проходам перед расчётом проекта.",
    priceFrom: 3500,
  ...
  "kuhni-s-ostrovom": {
    title: "Кухни с островом на заказ — варианты и стоимость",
    description: "Кухни с островом на заказ: варианты для готовки, хранения и общения. Проверьте проходы, размеры острова и коммуникации, затем рассчитайте комплектацию.",
    priceFrom: 4500,
  ...
  "malenkie-kuhni": {
    title: "Маленькие кухни на заказ — компактные планировки",
    description: "Маленькие кухни на заказ: компактные прямые и угловые планировки, хранение и встроенная техника. Выберите решение для своего помещения и рассчитайте цену.",
    priceFrom: 900,
  ...
  "kuhni-do-potolka": {
    title: "Кухни до потолка на заказ — высокие шкафы и антресоли",
    description: "Кухни до потолка на заказ: высокие шкафы, антресоли и варианты фасадов. Сравните доступ к хранению, вентиляцию и монтажные зазоры перед расчётом кухни.",
    priceFrom: 2200,
  ...
  "kuhni-bez-ruchek": {
    title: "Кухни без ручек на заказ — профили и открывание",
    description: "Кухни без ручек на заказ: профиль, фрезерованный хват и открывание нажатием. Сравните удобство для ящиков и встроенной техники, выберите комплектацию.",
    priceFrom: 2000,
