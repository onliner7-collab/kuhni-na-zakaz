...
const STATIC_CATEGORIES: Record<string, StaticCategory> = {
  "uglovye-kuhni": {
    ...
    description: "Угловые кухни на заказ в Минске — оптимальное использование угловых зон. От 1 800 BYN. Условия замера уточняются при заявке.",
    priceFrom: 1800,
  ...
  "pryamye-kuhni": {
    title: "Модульные прямые кухни купить в Минске",
    description: "Модульные прямые кухни в Минске — сравним готовые решения и изготовление по размерам. От 1 200 BYN. Условия замера уточняются при заявке.",
    priceFrom: 1200,
  ...
  "p-obraznye-kuhni": {
    ...
    description: "П-образные кухни на заказ — максимум рабочего пространства. От 3 500 BYN. Условия замера уточняются при заявке.",
    priceFrom: 3500,
  ...
  "kuhni-s-ostrovom": {
    ...
    description: "Кухни с островом на заказ — для открытых пространств. От 4 500 BYN. Условия замера уточняются при заявке.",
    priceFrom: 4500,
  ...
  "malenkie-kuhni": {
    ...
    description: "Маленькие кухни на заказ до 2 п.м — Минск и область. От 900 BYN. Условия замера уточняются при заявке.",
    priceFrom: 900,
  ...
  "kuhni-do-potolka": {
    ...
    description: "Кухни с фасадами до потолка — максимум хранения. От 2 200 BYN. Условия замера уточняются при заявке.",
    priceFrom: 2200,
