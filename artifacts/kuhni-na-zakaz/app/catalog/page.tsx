...
export const metadata: Metadata = {
  title: "Каталог кухонь на заказ в Минске",
  description: "Каталог кухонь на заказ: угловые, прямые, П-образные, с островом, маленькие. Цены от 900 BYN. Собственное производство.",
  alternates: { canonical: "/catalog" },
};

const DEFAULT_CATEGORIES = [
  { slug: "uglovye-kuhni", title: "Угловые кухни", description: "Оптимальное использование угловых зон. Подходят для помещений от 8 м².", priceFrom: 1800, features: ["Эффективный угол", "Вместительность", "Зонирование"] },
  ...
  { slug: "p-obraznye-kuhni", title: "П-образные кухни", description: "Максимум рабочего пространства. Идеальны для кухонь от 14 м².", priceFrom: 3500, features: ["Максимум хранения", "Большая рабочая зона", "Разделение зон"] },
  ...
  { slug: "malenkie-kuhni", title: "Маленькие кухни", description: "Кухни до 8 м². Оптимальные решения для квартир-студий.", priceFrom: 900, features: ["Компактность", "Встроенная техника", "Вертикальное хранение"] },
