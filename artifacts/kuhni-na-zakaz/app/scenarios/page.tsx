...
const STATIC_SCENARIOS = [
  { slug: "semya-s-detmi", icon: "👨‍👩‍👧‍👦", badge: "Популярный", title: "Кухня для семьи с детьми", intro: "Безопасно, вместительно, легко убирать. Проектируем под реальную жизнь с детьми." },
  { slug: "malenkaya-kukhnya", icon: "📐", badge: "Запрос №1", title: "Маленькая кухня", intro: "1.5–2 п.м — не приговор. Знаем, как выжать максимум из любого метража." },
  { slug: "kukhnya-gostinaya", icon: "🛋️", badge: "", title: "Кухня-гостиная", intro: "Объединённое пространство, которое выглядит как дизайнерский интерьер, а не кухня-«рабочая»." },
  { slug: "lyublyu-gotovit", icon: "👨‍🍳", badge: "Для гурмана", title: "Кухня для тех, кто любит готовить", intro: "Большая рабочая зона, правильное хранение инвентаря, техника на правильной высоте." },
  { slug: "bez-pereplaty", icon: "💰", badge: "Выгодно", title: "Кухня без переплаты", intro: "Производим сами — без наценки посредника. Качество и гарантия, честная цена." },
  { slug: "maksimum-khraneniya", icon: "🗄️", badge: "", title: "Хочу максимум хранения", intro: "У каждой вещи — своё место. Системы Blum, шкафы до потолка, угловые карусели." },
];
...
export default async function ScenariosPage() {
  ...
  const scenarios = dbScenarios.length > 0 ? dbScenarios : STATIC_SCENARIOS;
