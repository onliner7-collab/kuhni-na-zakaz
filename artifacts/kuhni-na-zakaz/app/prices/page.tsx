...
const description =
  "Сколько стоит кухня на заказ: ориентиры цен, примеры комплектаций и факторы стоимости. Сравните материалы и фурнитуру, отправьте размеры для расчёта сметы.";
...
const PRICE_AI_SCENARIOS = [
  {
    title: "Что входит в стоимость кухни",
    text: "Сравнивайте не только стартовую цену, но и состав сметы: корпус, фасады, столешницу, фурнитуру, замер, доставку и монтаж. Уточните, какие работы оплачиваются отдельно.",
  },
  {
    title: "Как уменьшить бюджет",
    text: "Сравните простую планировку, практичные фасады и необходимый набор механизмов. Обсудите, какие изменения действительно снижают смету, сохраняя удобство ежедневных зон.",
  },
  {
    title: "Как сравнить две сметы",
    text: "Зафиксируйте одинаковые размеры, материалы фасадов и столешницы, модели фурнитуры и состав работ. Проверьте, включены ли техника, доставка и монтаж, прежде чем сравнивать итоговые суммы.",
  },
];
    ...
    <>
      ...
      <div className="bg-white">
          ...
          <div className="grid gap-7 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-2 text-4xl font-black leading-tight text-stone-950 md:text-5xl">
                Цены на кухни на заказ и расчёт сметы
              </h1>
        ...
        <div className="container-site py-12 md:py-16">
          ...
          <section className="mb-12">
            <h2 className="font-serif text-3xl font-bold text-foreground">Сколько стоит кухня на заказ</h2>
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
