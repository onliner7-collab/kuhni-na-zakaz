...
export const metadata: Metadata = {
  ...
  description: "Условия использования сайта КухниMinsk.",
    ...
    <div className="section-padding">
      <div className="container-site max-w-3xl">
        ...
        <div className="prose prose-stone max-w-none space-y-6 text-muted-foreground">
          <p>Используя сайт kuhniminsk.by, вы принимаете настоящие условия использования.</p>
          <h2 className="font-serif text-xl font-semibold text-foreground">1. Интеллектуальная собственность</h2>
          <p>Все материалы сайта (тексты, изображения, логотипы) являются собственностью КухниMinsk. Копирование без разрешения запрещено.</p>
