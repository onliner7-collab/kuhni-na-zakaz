...
export const metadata: Metadata = {
  ...
  description: "Политика конфиденциальности КухниMinsk.",
    ...
    <div className="section-padding">
      <div className="container-site max-w-3xl">
        ...
        <div className="prose prose-stone max-w-none space-y-6 text-muted-foreground">
          <p>Настоящая политика конфиденциальности описывает, как КухниMinsk собирает, использует и защищает персональные данные пользователей сайта.</p>
          ...
          <p>Вы вправе запросить удаление своих данных. Для этого обратитесь по email: info@kuhniminsk.by</p>
          <h2 className="font-serif text-xl font-semibold text-foreground">5. Контакты</h2>
          <p>КухниMinsk | info@kuhniminsk.by | +375 (29) 123-45-67</p>
        </div>
      </div>
    </div>
  );
