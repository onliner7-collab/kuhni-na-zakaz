          ...
          <table className="w-full text-sm">
            <thead className="bg-muted/30 border-b border-border">
              <tr>
                ...
                <th className="text-left px-4 py-3 font-medium text-foreground">Стиль</th>
                <th className="text-left px-4 py-3 font-medium text-foreground">Статус</th>
                <th className="text-left px-4 py-3 font-medium text-foreground">Дата</th>
            ...
            <tbody className="divide-y divide-border">
              {cases.map((c) => (
                <tr key={c.id} className="hover:bg-muted/20 transition-colors">
                  ...
                  <td className="px-4 py-3 text-muted-foreground">{c.style || "—"}</td>
                  <td className="px-4 py-3">
                    {c.published ? (
