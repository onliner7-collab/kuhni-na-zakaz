...
export default defineConfig({
  ...
  testMatch: "stages-19-21.spec.ts",
  outputDir: "../../artifacts/visual-rescue/stages-19-21/playwright-results",
  timeout: 90_000,
  fullyParallel: false,
  workers: 1,
  reporter: [
    ["list"],
    ["json", { outputFile: "../../artifacts/visual-rescue/stages-19-21/playwright-report.json" }],
  ],
  use: {
